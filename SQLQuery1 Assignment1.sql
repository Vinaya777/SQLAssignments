...
insert into Customers values(20,'Ethan','Sydney','Australia',121116,101,250000)
insert into Customers values(22,'Amelia','Nova ','	Bahrain',121117,102,350000)
insert into Customers values(24,' Mia','Scotia','Bagaladesh',121114,103,450000)
insert into Customers values(26,'Lucas','Corner Brook','Brazil',121115,104,550000)
insert into Customers values(28,'Chloe','Berlin','Canada',121110,105,650000)
insert into Customers values(210,'Ava','Moncton','Cuba',121118,106,750000)
insert into Customers values(212,'Noah','London','Dominica',121110,107,850000)
insert into Customers values(214,'Enzo','Alberta','Georgia',123119,108,950000)
insert into Customers values(216,'Lea','Manitoba','Iceland',121120,109,1050000)
insert into Customers values(218,'Mathias','Prince Edward Island','Ireland',121110,140,5750000)
insert into Customers values(218,'Max','Prince Edward Island','Maldives',121210,141,5450000)

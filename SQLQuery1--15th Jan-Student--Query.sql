...
insert into Student values
	(1, 'Rucha', 'BTech', cast('11-21-1998' as date), 101, 201, 75000, 'regular', 'no'),
	(2, 'Aditi', 'BE', cast('3-8-2003' as date), 102, 202, 55000, 'regular', 'no'),
	(3, 'Namita', 'BA', cast('12-24-2000' as date), 103, 203, 60000, 'regular', 'yes'),
	(4, 'Riyaaa', 'BSc', cast('1-26-1997' as date), 104, 204, 70000, 'regular', 'yes'),
	(5, 'Dipeeka', 'BE', cast('7-17-1998' as date), 105, 205, 35000, 'distance', 'no'),
	(6, 'minaal', 'BTech', cast('10-16-1999' as date), 106, 206, 80000, 'regular', 'yes'),
	(7, 'kirti', 'BTech', cast('1-3-2001' as date), 101, 201, 90000, 'regular', 'yes')
select * from Student
create table Course 
(	
	courseId int, 
...
insert into Trainer values
	(301, 'jeet', cast('12-2-2014' as date), 'temp5@gmail.com',4),
	(302, 'Rupali', cast('6-20-2016' as date), 'temp2@gmail.com',2),
	(303, 'Yashaswini', cast('18-12-2010' as date), 'temp8@gmail.com',5),
	(304, 'Vaishavni', cast('4-15-2012' as date), 'temp19@gmail.com',9),
	(305, 'Sahil', cast('12-1-2019' as date), 'temp69@gmail.com',8),
	(306, 'shreyas', cast('8-1-2015' as date), 'temp67@gmail.com',6)
select *from Trainer
